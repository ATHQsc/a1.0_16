...
/*     */ 
/*     */     
/* 219 */     this.a = 0; this.ay = 1.62F; c(paramcj.m + 0.5D, (paramcj.n + 1), paramcj.o + 0.5D, 0.0F, 0.0F); this.D = 20; this.x = "humanoid"; this.w = 180.0F; this.aP = 20; this.u = "/char.png"; }
...
/* 228 */       if (this.ad.j == 0) paramInt = 0; 
/* 229 */       if (this.ad.j == 1) paramInt = paramInt / 3 + 1; 
/* 230 */       if (this.ad.j == 3) paramInt = paramInt * 3 / 2;
/*     */     
/*     */     } 
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\dg.class
