...
/* 254 */     while (i != j) {
/* 255 */       arrayOfInt2[b2] = ei.b((paramArrayOfint1[b2] + i) + 0.5D);
/* 256 */       arrayOfInt2[b3] = ei.b(paramArrayOfint1[b3] + i * d1 + 0.5D);
/* 257 */       arrayOfInt2[b4] = ei.b(paramArrayOfint1[b4] + i * d2 + 0.5D);
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\ed.class
