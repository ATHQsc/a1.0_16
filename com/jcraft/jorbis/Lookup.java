...
/*     */ 
/*     */   
/*     */   static float coslook(float paramFloat) {
/*  78 */     double d = paramFloat * 40.74366592D;
/*  79 */     int i = (int)d;
...
/*     */ 
/*     */   
/*     */   static float invsqlook(float paramFloat) {
/*  96 */     double d = (paramFloat * 64.0F - 32.0F);
/*  97 */     int i = (int)d;
...
/*     */ 
/*     */   
/*     */   static float invsq2explook(int paramInt) {
/* 119 */     return INVSQ2EXP_LOOKUP[paramInt - -32];
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   static float fromdBlook(float paramFloat) {
/* 147 */     int i = (int)(paramFloat * -8.0F);
/* 148 */     return (i < 0) ? 1.0F : ((i >= 1120) ? 0.0F : (FROMdB_LOOKUP[i >>> 5] * FROMdB2_LOOKUP[i & 0x1F]));
/*     */   }
/*     */ }


/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\com\jcraft\jorbis\Lookup.class
