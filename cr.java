...
/* 31 */     float f = 0.7F;
/* 32 */     double d1 = (paramcj.l.nextFloat() * f) + (1.0F - f) * 0.5D;
/* 33 */     double d2 = (paramcj.l.nextFloat() * f) + (1.0F - f) * 0.2D + 0.6D;
/* 34 */     double d3 = (paramcj.l.nextFloat() * f) + (1.0F - f) * 0.5D;
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\cr.class
