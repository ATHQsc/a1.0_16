...
/*     */     }
/*     */     
/*  31 */     double d1 = (this.f + this.e.l.nextFloat());
/*  32 */     double d2 = (this.g + this.e.l.nextFloat());
/*  33 */     double d3 = (this.h + this.e.l.nextFloat());
...
/*     */       } 
/*  62 */       if (fv != null) {
/*  63 */         double d4 = this.f + (this.e.l.nextDouble() - this.e.l.nextDouble()) * 4.0D;
/*  64 */         double d5 = (this.g + this.e.l.nextInt(3) - 1);
/*  65 */         double d6 = this.h + (this.e.l.nextDouble() - this.e.l.nextDouble()) * 4.0D;
/*     */         
/*  67 */         fv.c(d4, d5, d6, this.e.l.nextFloat() * 360.0F, 0.0F);
/*     */         
/*  69 */         if (fv.a()) {
/*  70 */           this.e.a(fv);
/*     */           
...
/*     */             
/*  74 */             d1 = this.f + 0.5D + (this.e.l.nextFloat() - 0.5D) * 2.0D;
/*  75 */             d2 = this.g + 0.5D + (this.e.l.nextFloat() - 0.5D) * 2.0D;
/*  76 */             d3 = this.h + 0.5D + (this.e.l.nextFloat() - 0.5D) * 2.0D;
/*     */             
...
/*     */   
/*     */   private void c() {
/*  92 */     this.a = 200 + this.e.l.nextInt(600);
/*     */   }
/*     */   
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\ba.class
