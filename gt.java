...
/*  89 */       if (paramcj.l.nextInt(15) <= paramInt4) {
/*  90 */         float f1 = 0.7F;
/*  91 */         float f2 = paramcj.l.nextFloat() * f1 + (1.0F - f1) * 0.5F;
/*  92 */         float f3 = paramcj.l.nextFloat() * f1 + (1.0F - f1) * 0.5F;
/*  93 */         float f4 = paramcj.l.nextFloat() * f1 + (1.0F - f1) * 0.5F;
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\gt.class
