...
/*     */   public int g;
/*     */   
/*     */   public kc(bu parambu, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6) {
/*  11 */     this.a = parambu;
/*  12 */     this.b = paramInt1;
/*  13 */     this.c = paramInt2;
/*  14 */     this.d = paramInt3;
...
/*  31 */         if (paramcj.d(n, 0, i1)) {
/*  32 */           for (int i2 = this.c; i2 <= this.f; i2++) {
/*  33 */             if (i2 >= 0 && i2 < 128) {
/*  34 */               int i3 = paramcj.a(this.a, n, i2, i1);
/*     */               
/*  36 */               int i4 = 0;
/*  37 */               int i5 = paramcj.a(n, i2, i1);
/*  38 */               int i6 = ln.q[i5];
/*  39 */               if (i6 == 0) i6 = 1; 
/*  40 */               int i7 = 0;
/*  41 */               if (this.a == bu.a) {
/*  42 */                 if (paramcj.k(n, i2, i1)) i7 = 15; 
/*  43 */               } else if (this.a == bu.b) {
/*  44 */                 i7 = ln.s[i5];
/*     */               } 
/*     */               
/*  47 */               if (i6 >= 15 && i7 == 0) {
...
/*     */               } else {
/*     */                 
/*  51 */                 int i8 = paramcj.a(this.a, n - 1, i2, i1);
/*  52 */                 int i9 = paramcj.a(this.a, n + 1, i2, i1);
/*  53 */                 int i10 = paramcj.a(this.a, n, i2 - 1, i1);
/*  54 */                 int i11 = paramcj.a(this.a, n, i2 + 1, i1);
/*  55 */                 int i12 = paramcj.a(this.a, n, i2, i1 - 1);
/*  56 */                 int i13 = paramcj.a(this.a, n, i2, i1 + 1);
/*     */                 
/*  58 */                 i4 = i8;
/*  59 */                 if (i9 > i4) i4 = i9; 
/*  60 */                 if (i10 > i4) i4 = i10; 
...
/*     */               
/*  71 */               if (i3 != i4) {
/*  72 */                 paramcj.b(this.a, n, i2, i1, i4);
/*  73 */                 int i8 = i4 - 1;
/*  74 */                 if (i8 < 0) i8 = 0; 
/*  75 */                 paramcj.a(this.a, n - 1, i2, i1, i8);
/*  76 */                 paramcj.a(this.a, n, i2 - 1, i1, i8);
/*  77 */                 paramcj.a(this.a, n, i2, i1 - 1, i8);
/*     */                 
/*  79 */                 if (n + 1 >= this.e) paramcj.a(this.a, n + 1, i2, i1, i8); 
/*  80 */                 if (i2 + 1 >= this.f) paramcj.a(this.a, n, i2 + 1, i1, i8); 
/*  81 */                 if (i1 + 1 >= this.g) paramcj.a(this.a, n, i2, i1 + 1, i8);
/*     */               
/*     */               } 
/*     */             } 
/*     */           } 
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\kc.class
