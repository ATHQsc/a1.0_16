...
/*  13 */     paramcj.a(paramDouble1, paramDouble2, paramDouble3, "random.explode", 4.0F, (1.0F + (paramcj.l.nextFloat() - paramcj.l.nextFloat()) * 0.2F) * 0.7F);
/*     */     
...
/*  32 */             d3 /= d4;
/*     */             
/*  34 */             float f1 = paramFloat * (0.7F + paramcj.l.nextFloat() * 0.6F);
...
/* 108 */         double d1 = (i3 + paramcj.l.nextFloat());
/* 109 */         double d2 = (i4 + paramcj.l.nextFloat());
/* 110 */         double d3 = (i5 + paramcj.l.nextFloat());
/*     */         
...
/* 123 */         d8 *= (paramcj.l.nextFloat() * paramcj.l.nextFloat() + 0.3F);
/* 124 */         d4 *= d8;
/* 125 */         d5 *= d8;
/* 126 */         d6 *= d8;
/*     */         
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\iv.class
