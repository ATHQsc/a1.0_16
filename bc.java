...
/*  33 */     if (paramBoolean) b.add(new nc(paramInt1, paramInt2, paramInt3, paramcj.b)); 
/*  34 */     byte b1 = 0;
...
/*     */     
/* 108 */     while (b.size() > 0 && paramcj.b - ((nc)b.get(0)).d > 100L) {
/* 109 */       b.remove(0);
/*     */     }
/*     */     
/* 112 */     if (this.a) {
...
/* 117 */           paramcj.a((paramInt1 + 0.5F), (paramInt2 + 0.5F), (paramInt3 + 0.5F), "random.fizz", 0.5F, 2.6F + (paramcj.l.nextFloat() - paramcj.l.nextFloat()) * 0.8F);
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\bc.class
