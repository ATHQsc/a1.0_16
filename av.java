...
/*  36 */     int i = paramInt1 + paramcj.l.nextInt(16);
/*  37 */     int j = paramcj.l.nextInt(128);
/*  38 */     int k = paramInt2 + paramcj.l.nextInt(16);
/*     */     
...
/*  44 */     this.d.clear();
/*     */     byte b;
/*  46 */     for (b = 0; b < paramcj.i.size(); b++) {
/*  47 */       dg dg = paramcj.i.get(b);
...
/*  58 */     b = 0;
/*  59 */     for (nx nx : this.d) {
/*  60 */       if (paramcj.l.nextInt(10) != 0)
/*  61 */         continue;  int i = paramcj.l.nextInt(this.c.length);
/*     */       
...
/*  77 */           n += paramcj.l.nextInt(b2) - paramcj.l.nextInt(b2);
/*  78 */           i1 += paramcj.l.nextInt(1) - paramcj.l.nextInt(1);
/*  79 */           i2 += paramcj.l.nextInt(b2) - paramcj.l.nextInt(b2);
/*     */ 
/*     */           
...
/*     */ 
/*     */               
/*  89 */               float f4 = f1 - paramcj.m;
/*  90 */               float f5 = f2 - paramcj.n;
/*  91 */               float f6 = f3 - paramcj.o;
...
/*     */                 } 
/*     */                 
/* 106 */                 fv.c(f1, f2, f3, paramcj.l.nextFloat() * 360.0F, 0.0F);
/*     */                 
/* 108 */                 if (fv.a())
/* 109 */                 { b++;
/* 110 */                   paramcj.a(fv); } 
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\av.class
