...
/* 52 */     int i = dd.aB.aQ;
/* 53 */     float f = 0.7F;
/* 54 */     double d1 = (paramcj.l.nextFloat() * f) + (1.0F - f) * 0.5D;
/* 55 */     double d2 = (paramcj.l.nextFloat() * f) + (1.0F - f) * 0.5D;
/* 56 */     double d3 = (paramcj.l.nextFloat() * f) + (1.0F - f) * 0.5D;
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\ev.class
