...
/* 24 */       parameo.b(1);
/*    */       
/* 26 */       if (paramcj.l.nextInt(8) == 0 && i == ln.u.ba) {
/* 27 */         byte b1 = 1;
/* 28 */         for (byte b2 = 0; b2 < b1; b2++) {
/* 29 */           float f1 = 0.7F;
/* 30 */           float f2 = paramcj.l.nextFloat() * f1 + (1.0F - f1) * 0.5F;
/* 31 */           float f3 = 1.2F;
/* 32 */           float f4 = paramcj.l.nextFloat() * f1 + (1.0F - f1) * 0.5F;
...
/* Location:              C:\Users\Stf\Desktop\a1.0.16.jar!\fl.class
